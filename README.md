A simple program that computes the Knapsack problem using branch-and-bound (fractional method) (School Project, Algorithmic and Operations Reseach class, 2017).
